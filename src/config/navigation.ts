...
export const navigationModules: NavModule[] = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      { slug: 'get-alerts', title: 'Listar alertas', method: 'GET', path: '/alerts', summary: 'Obtiene el listado paginado de alertas visibles de la empresa.', status: 'documented' },
  ...
  },
  {
    ...
    endpoints: [
      { slug: 'register-branch', title: 'Crear sucursal', method: 'POST', path: '/branches', summary: 'Crea una sucursal para la empresa.', status: 'documented' },
      { slug: 'get-branches', title: 'Listar sucursales', method: 'GET', path: '/branches', summary: 'Obtiene el listado paginado de sucursales.', status: 'documented' },
      ...
      { slug: 'update-branch', title: 'Actualizar sucursal', method: 'PATCH', path: '/branches/:id', summary: 'Actualiza una sucursal por su identificador.', status: 'documented' }
    ]
  },
  {
    slug: 'brand',
    ...
    endpoints: [
      { slug: 'register-brand', title: 'Crear marca', method: 'POST', path: '/brands', summary: 'Crea una nueva marca.', status: 'documented' },
      { slug: 'get-brands', title: 'Listar marcas', method: 'GET', path: '/brands', summary: 'Obtiene el listado paginado de marcas.', status: 'documented' },
      { slug: 'get-brand-by-id', title: 'Obtener marca', method: 'GET', path: '/brands/:id', summary: 'Obtiene una marca por su identificador.', status: 'documented' },
      { slug: 'update-brand', title: 'Actualizar marca', method: 'PATCH', path: '/brands/:id', summary: 'Actualiza una marca por su identificador.', status: 'documented' }
    ]
  },
  {
    slug: 'category',
    ...
    endpoints: [
      { slug: 'register-category', title: 'Crear categoría', method: 'POST', path: '/categories', summary: 'Crea una nueva categoría.', status: 'documented' },
      { slug: 'get-categories', title: 'Listar categorías', method: 'GET', path: '/categories', summary: 'Obtiene el listado paginado de categorías.', status: 'documented' },
      { slug: 'get-category-by-id', title: 'Obtener categoría', method: 'GET', path: '/categories/:id', summary: 'Obtiene una categoría por su identificador.', status: 'documented' },
      { slug: 'update-category', title: 'Actualizar categoría', method: 'PATCH', path: '/categories/:id', summary: 'Actualiza una categoría.', status: 'documented' }
    ]
  },
  {
    slug: 'checkout',
    ...
    endpoints: [
      { slug: 'register-checkout', title: 'Crear caja', method: 'POST', path: '/checkouts', summary: 'Crea una nueva caja registradora.', status: 'documented' },
      { slug: 'get-checkouts', title: 'Listar cajas', method: 'GET', path: '/checkouts', summary: 'Obtiene el listado paginado de cajas.', status: 'documented' },
      { slug: 'get-checkout-by-id', title: 'Obtener caja', method: 'GET', path: '/checkouts/:id', summary: 'Obtiene una caja por su identificador.', status: 'documented' },
      { slug: 'update-checkout-status', title: 'Actualizar estado de caja', method: 'PATCH', path: '/checkouts/:id', summary: 'Abre o cierra el estado operativo de una caja.', status: 'documented' }
    ]
  },
  {
    slug: 'client',
    ...
    endpoints: [
      { slug: 'register-client', title: 'Crear cliente', method: 'POST', path: '/clients', summary: 'Crea un nuevo cliente.', status: 'documented' },
      { slug: 'get-clients', title: 'Listar clientes', method: 'GET', path: '/clients', summary: 'Obtiene el listado paginado de clientes.', status: 'documented' },
      { slug: 'get-client-by-id', title: 'Obtener cliente', method: 'GET', path: '/clients/:id', summary: 'Obtiene un cliente por su identificador o cédula/RUC.', status: 'documented' },
  ...
  },
  {
    ...
    endpoints: [
      { slug: 'register-company', title: 'Crear empresa', method: 'POST', path: '/companies', summary: 'Registra una nueva empresa en el sistema.', status: 'documented' },
      { slug: 'get-companies', title: 'Listar empresas', method: 'GET', path: '/companies', summary: 'Obtiene el listado paginado de empresas.', status: 'documented' },
      ...
      { slug: 'update-company', title: 'Actualizar empresa', method: 'PUT', path: '/companies/:id', summary: 'Actualiza la información comercial y visual de la empresa.', status: 'documented' },
  ...
  },
  {
    ...
    endpoints: [
      { slug: 'register-config', title: 'Crear configuración', method: 'POST', path: '/configs', summary: 'Crea un nuevo parámetro de configuración.', status: 'documented' },
      ...
      { slug: 'get-config-by-key', title: 'Obtener configuración por clave', method: 'GET', path: '/configs/:key', summary: 'Obtiene el valor de un parámetro de configuración por su clave.', status: 'documented' },
      { slug: 'update-config', title: 'Actualizar configuración', method: 'PUT', path: '/configs/:key', summary: 'Actualiza el valor de un parámetro existente.', status: 'documented' },
      { slug: 'delete-config', title: 'Eliminar configuración', method: 'DELETE', path: '/configs/:key', summary: 'Elimina un parámetro de configuración por su clave.', status: 'documented' }
    ]
  },
  {
    slug: 'medida',
  ...
  },
  {
    ...
    endpoints: [
      { slug: 'register-playment-method', title: 'Crear método de pago', method: 'POST', path: '/payment-methods', summary: 'Crea un nuevo método de pago.', status: 'documented' },
  ...
  },
  {
    ...
    endpoints: [
      ...
      { slug: 'update-product', title: 'Actualizar producto', method: 'PUT', path: '/products/:id', summary: 'Actualiza la información comercial y características de un producto.', status: 'documented' }
    ]
  },
  {
    slug: 'proforma',
  ...
  },
  {
    ...
    endpoints: [
      ...
      { slug: 'get-stocks-by-company', title: 'Listar stock por empresa', method: 'GET', path: '/stocks/empresa', summary: 'Obtiene el inventario consolidado a nivel de empresa.', status: 'documented' },
  ...
  },
  {
    ...
    endpoints: [
      { slug: 'health', title: 'Verificación de salud', method: 'GET', path: '/', summary: 'Endpoint raíz para validar que la API está viva.', status: 'documented' }
    ]
  },
  {
    slug: 'user',
    ...
    endpoints: [
      ...
      { slug: 'update-user', title: 'Actualizar usuario', method: 'PUT', path: '/users/:id', summary: 'Actualiza la información personal de un usuario.', status: 'documented' },

...
export const metadata = { title: 'Obtener Product' }
...
export default function ObtenerProductPage() {
  ...
  const endpoint = {
    ...
    bodyGroups: [],
    curlExample: `curl -X GET https://api.tudominio.com/products/:id \
  ...
  "prdtoestado": "activo"
    ...
    businessRules: [
    'Solo permite ver productos de la misma empresa del usuario autenticado.',
    ...
    { status: 500, title: 'Product not found', message: 'Producto no encontrado' },

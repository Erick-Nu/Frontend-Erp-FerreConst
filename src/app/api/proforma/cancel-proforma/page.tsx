...
export default function AnularProformaPage() {
  ...
  const endpoint = {
    ...
    summary: 'Anula una proforma y cambia su estado a anulada.',
    ...
    bodyGroups: [],
    curlExample: `curl -X PATCH https://api.tudominio.com/proformas/:id/cancel \
  ...
  "proforma": {
    ...
    businessRules: [
    'Solo una proforma en estado emitida puede anularse.',
    'No realiza movimientos de stock.',
    ...
    { status: 409, title: 'Only emitted proformas can be canceled' },

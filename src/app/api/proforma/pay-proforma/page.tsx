...
export default function PagarProformaPage() {
  ...
  const endpoint = {
    ...
    summary: 'Marca una proforma como pagada y descuenta stock de los ítems inventariables.',
    ...
    bodyGroups: [],
    curlExample: `curl -X PATCH https://api.tudominio.com/proformas/:id/pay \
  ...
  "proforma": {
    ...
    businessRules: [
    'Solo una proforma en estado emitida puede pagarse.',
    'Solo descuenta stock de ítems inventariables.',
    'Valida existencia de stock en la sucursal de emisión de la proforma.',
    'Si no hay stock suficiente o el stock no está activo, retorna conflicto.',
    ...
    { status: 500, title: 'Only emitted proformas can be paid' },
    { status: 500, title: 'Stock does not exist for branch and product' },
    { status: 500, title: 'Stock is not active' },
    { status: 500, title: 'Insufficient stock quantity' },
    { status: 500, title: 'Proforma must contain at least one item' },

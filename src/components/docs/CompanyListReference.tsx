...
type CompanyListReferenceProps = {
  moduleTitle: string
  moduleSlug: string
  endpoint: CompanyListEndpoint
}

export function CompanyListReference({ moduleTitle, moduleSlug, endpoint }: CompanyListReferenceProps) {
  return (
    <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_440px] 2xl:grid-cols-[minmax(0,1fr)_500px]">
      <article className="min-w-0 pb-16 sm:pb-20">
        ...
        <div className="mt-8 xl:hidden">
          <CompanyListPreviewPanel endpoint={endpoint} />
        </div>
...
function CompanyListPreviewPanel({ endpoint }: { endpoint: CompanyListEndpoint }) {

...
type ProformaListReferenceProps = {
  moduleTitle: string
  moduleSlug: string
  endpoint: ProformaListEndpoint
}

export function ProformaListReference({ moduleTitle, moduleSlug, endpoint }: ProformaListReferenceProps) {
  return (
    <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_440px] 2xl:grid-cols-[minmax(0,1fr)_500px]">
      <article className="min-w-0 pb-16 sm:pb-20">
        ...
        <div className="mt-8 xl:hidden">
          <ProformaListPreviewPanel endpoint={endpoint} />
        </div>
...
function ProformaListPreviewPanel({ endpoint }: { endpoint: ProformaListEndpoint }) {

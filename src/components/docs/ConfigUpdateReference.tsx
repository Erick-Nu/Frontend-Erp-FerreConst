...
type ConfigUpdateReferenceProps = {
  moduleTitle: string
  moduleSlug: string
  endpoint: ConfigUpdateEndpoint
}

export function ConfigUpdateReference({ moduleTitle, moduleSlug, endpoint }: ConfigUpdateReferenceProps) {
  return (
    <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_440px] 2xl:grid-cols-[minmax(0,1fr)_500px]">
      <article className="min-w-0 pb-16 sm:pb-20">
        ...
        <div className="mt-8 xl:hidden">
          <ConfigUpdatePreviewPanel endpoint={endpoint} />
        </div>
...
function ConfigUpdatePreviewPanel({ endpoint }: { endpoint: ConfigUpdateEndpoint }) {

...
type ClientUpdateReferenceProps = {
  moduleSlug: string
  moduleTitle: string
  endpoint: ClientUpdateEndpoint
}

export function ClientUpdateReference({ moduleSlug, moduleTitle, endpoint }: ClientUpdateReferenceProps) {
  return (
    <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_440px] 2xl:grid-cols-[minmax(0,1fr)_500px]">
      <article className="min-w-0 pb-16 sm:pb-20">
        ...
        <div className="mt-8 xl:hidden">
          <ClientUpdatePreviewPanel endpoint={endpoint} />
        </div>
...
function ClientUpdatePreviewPanel({ endpoint }: { endpoint: ClientUpdateEndpoint }) {

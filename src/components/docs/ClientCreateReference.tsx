...
type ClientCreateReferenceProps = {
  moduleSlug: string
  moduleTitle: string
  endpoint: ClientCreateEndpoint
}

export function ClientCreateReference({ moduleSlug, moduleTitle, endpoint }: ClientCreateReferenceProps) {
  return (
    <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_440px] 2xl:grid-cols-[minmax(0,1fr)_500px]">
      <article className="min-w-0 pb-16 sm:pb-20">
        ...
        <div className="mt-8 xl:hidden">
          <ClientCreatePreviewPanel endpoint={endpoint} />
        </div>
...
function ClientCreatePreviewPanel({ endpoint }: { endpoint: ClientCreateEndpoint }) {

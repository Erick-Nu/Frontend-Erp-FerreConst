...
type CompanyStatusReferenceProps = {
  moduleTitle: string
  moduleSlug: string
  endpoint: CompanyStatusEndpoint
}

export function CompanyStatusReference({ moduleTitle, moduleSlug, endpoint }: CompanyStatusReferenceProps) {
  return (
    <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_440px] 2xl:grid-cols-[minmax(0,1fr)_500px]">
      <article className="min-w-0 pb-16 sm:pb-20">
        ...
        <div className="mt-8 xl:hidden">
          <CompanyStatusPreviewPanel endpoint={endpoint} />
        </div>
...
function CompanyStatusPreviewPanel({ endpoint }: { endpoint: CompanyStatusEndpoint }) {

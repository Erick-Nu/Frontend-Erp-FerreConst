...
type CategoryListReferenceProps = {
  moduleTitle: string
  moduleSlug: string
  endpoint: CategoryListEndpoint
}

export function CategoryListReference({ moduleTitle, moduleSlug, endpoint }: CategoryListReferenceProps) {
  return (
    <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_440px] 2xl:grid-cols-[minmax(0,1fr)_500px]">
      <article className="min-w-0 pb-16 sm:pb-20">
        ...
        <div className="mt-8 xl:hidden">
          <CategoryListPreviewPanel endpoint={endpoint} />
        </div>
...
function CategoryListPreviewPanel({ endpoint }: { endpoint: CategoryListEndpoint }) {

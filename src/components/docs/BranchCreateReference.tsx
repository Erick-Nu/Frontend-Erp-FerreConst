...
type BranchCreateReferenceProps = {
  moduleTitle: string
  moduleSlug: string
  endpoint: BranchCreateEndpoint
}

export function BranchCreateReference({ moduleTitle, moduleSlug, endpoint }: BranchCreateReferenceProps) {
  return (
    <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_440px] 2xl:grid-cols-[minmax(0,1fr)_500px]">
      <article className="min-w-0 pb-16 sm:pb-20">
        ...
        <div className="mt-8 xl:hidden">
          <BranchCreatePreviewPanel endpoint={endpoint} />
        </div>
...
function BranchCreatePreviewPanel({ endpoint }: { endpoint: BranchCreateEndpoint }) {

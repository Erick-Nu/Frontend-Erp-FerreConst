...
type ProductByIdReferenceProps = {
  moduleTitle: string
  moduleSlug: string
  endpoint: ProductByIdEndpoint
}

export function ProductByIdReference({ moduleTitle, moduleSlug, endpoint }: ProductByIdReferenceProps) {
  return (
    <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_440px] 2xl:grid-cols-[minmax(0,1fr)_500px]">
      <article className="min-w-0 pb-16 sm:pb-20">
        ...
        <div className="mt-8 xl:hidden">
          <ProductByIdPreviewPanel endpoint={endpoint} />
        </div>
...
function ProductByIdPreviewPanel({ endpoint }: { endpoint: ProductByIdEndpoint }) {

...
type ConfigDeleteReferenceProps = {
  moduleTitle: string
  moduleSlug: string
  endpoint: ConfigDeleteEndpoint
}

export function ConfigDeleteReference({ moduleTitle, moduleSlug, endpoint }: ConfigDeleteReferenceProps) {
  return (
    <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_440px] 2xl:grid-cols-[minmax(0,1fr)_500px]">
      <article className="min-w-0 pb-16 sm:pb-20">
        ...
        <div className="mt-8 xl:hidden">
          <ConfigDeletePreviewPanel endpoint={endpoint} />
        </div>
...
function ConfigDeletePreviewPanel({ endpoint }: { endpoint: ConfigDeleteEndpoint }) {

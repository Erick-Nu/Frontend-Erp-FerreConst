...
type BrandUpdateReferenceProps = {
  moduleTitle: string
  moduleSlug: string
  endpoint: BrandUpdateEndpoint
}

export function BrandUpdateReference({ moduleTitle, moduleSlug, endpoint }: BrandUpdateReferenceProps) {
  return (
    <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_440px] 2xl:grid-cols-[minmax(0,1fr)_500px]">
      <article className="min-w-0 pb-16 sm:pb-20">
        ...
        <div className="mt-8 xl:hidden">
          <BrandUpdatePreviewPanel endpoint={endpoint} />
        </div>
...
function BrandUpdatePreviewPanel({ endpoint }: { endpoint: BrandUpdateEndpoint }) {

...
type MedidaByIdReferenceProps = {
  moduleTitle: string
  moduleSlug: string
  endpoint: MedidaByIdEndpoint
}

export function MedidaByIdReference({ moduleTitle, moduleSlug, endpoint }: MedidaByIdReferenceProps) {
  return (
    <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_440px] 2xl:grid-cols-[minmax(0,1fr)_500px]">
      <article className="min-w-0 pb-16 sm:pb-20">
        ...
        <div className="mt-8 xl:hidden">
          <MedidaByIdPreviewPanel endpoint={endpoint} />
        </div>
...
function MedidaByIdPreviewPanel({ endpoint }: { endpoint: MedidaByIdEndpoint }) {

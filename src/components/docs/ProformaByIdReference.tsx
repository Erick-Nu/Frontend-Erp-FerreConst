...
type ProformaByIdReferenceProps = {
  moduleTitle: string
  moduleSlug: string
  endpoint: ProformaByIdEndpoint
}

export function ProformaByIdReference({ moduleTitle, moduleSlug, endpoint }: ProformaByIdReferenceProps) {
  return (
    <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_440px] 2xl:grid-cols-[minmax(0,1fr)_500px]">
      <article className="min-w-0 pb-16 sm:pb-20">
        ...
        <div className="mt-8 xl:hidden">
          <ProformaByIdPreviewPanel endpoint={endpoint} />
        </div>
...
function ProformaByIdPreviewPanel({ endpoint }: { endpoint: ProformaByIdEndpoint }) {

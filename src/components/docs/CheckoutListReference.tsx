...
type CheckoutListReferenceProps = {
  moduleTitle: string
  moduleSlug: string
  endpoint: CheckoutListEndpoint
}

export function CheckoutListReference({ moduleTitle, moduleSlug, endpoint }: CheckoutListReferenceProps) {
  return (
    <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_440px] 2xl:grid-cols-[minmax(0,1fr)_500px]">
      <article className="min-w-0 pb-16 sm:pb-20">
        ...
        <div className="mt-8 xl:hidden">
          <CheckoutListPreviewPanel endpoint={endpoint} />
        </div>
...
function CheckoutListPreviewPanel({ endpoint }: { endpoint: CheckoutListEndpoint }) {

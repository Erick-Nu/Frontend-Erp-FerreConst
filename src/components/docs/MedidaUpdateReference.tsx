...
type MedidaUpdateReferenceProps = {
  moduleTitle: string
  moduleSlug: string
  endpoint: MedidaUpdateEndpoint
}

export function MedidaUpdateReference({ moduleTitle, moduleSlug, endpoint }: MedidaUpdateReferenceProps) {
  return (
    <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_440px] 2xl:grid-cols-[minmax(0,1fr)_500px]">
      <article className="min-w-0 pb-16 sm:pb-20">
        ...
        <div className="mt-8 xl:hidden">
          <MedidaUpdatePreviewPanel endpoint={endpoint} />
        </div>
...
function MedidaUpdatePreviewPanel({ endpoint }: { endpoint: MedidaUpdateEndpoint }) {

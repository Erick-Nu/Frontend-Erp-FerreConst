...
type CheckoutStatusReferenceProps = {
  moduleTitle: string
  moduleSlug: string
  endpoint: CheckoutStatusEndpoint
}

export function CheckoutStatusReference({ moduleTitle, moduleSlug, endpoint }: CheckoutStatusReferenceProps) {
  return (
    <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_440px] 2xl:grid-cols-[minmax(0,1fr)_500px]">
      <article className="min-w-0 pb-16 sm:pb-20">
        ...
        <div className="mt-8 xl:hidden">
          <CheckoutStatusPreviewPanel endpoint={endpoint} />
        </div>
...
function CheckoutStatusPreviewPanel({ endpoint }: { endpoint: CheckoutStatusEndpoint }) {
